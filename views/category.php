            ...
            <form method="post">
                ...
                <div id="my-field" class="mx-4 mt-6">
                    <div>
                        ...
                        <p id="error-addInput" class="text-red-400 font-bold"></p>
                    </div>
                </div>
                <div id="drop-down" class="mx-4 mt-6">
                    <div>
                        <div>
                            ...
                            <p id="error-UpdateInput" class="text-red-400 font-bold"></p>
                        </div>
                    </div>
                </div>
...
<div id="delet-modal" class="fixed z-50 hidden top-0 left-0 w-full h-full flex items-center justify-center" style="background-color: rgba(0,0,0,0.5);">
    <div class="relative rounded-lg p-6 bg-white">
        <div class="flex justify-between items-center">
            ...
            <button class="text-gray-500 font-medium cursor-pointer" id="close-deletedModal"><i class="fa-solid text-lg fa-rectangle-xmark"></i></button>
        </div>
        <div class="mt-4">
        ...
        <div class="flex justify-end mt-4">
            <form method="post">
                ...
                <button type="button" class="px-4 py-2 rounded-md text-white bg-gray-600" id="cancel-deletedModal">Cancel</button>
