            ...
            <?php for ($i = 0; $i < $_SESSION["post_number"]; $i++) { ?>
                <div class="w-full px-4 border border-gray-200 bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l rounded-lg mb-2">
                        <div class="mb-6 pt-2">
                            ...
                            <input type="text" name="post-title[]" class="title bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="title" required>
                        </div>
                        <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                            ...
                            <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                ...
                                <textarea id="editor" name="post-content[]" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
                            </div>
                        </div>
                        <div class="mb-6">
