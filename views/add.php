<?php
$numberPosts = $_POST["number_posts"];
?>
<main id="dashboard-page">
    ...
    <section class="my-section flex-col bg-yellow-100 mt-20">
        <div class="w-4/5 border border-gray-200 bg-blue-400 rounded-lg mb-2">
            <form class="w-full px-2">
                <div class="mb-6">
                    <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Title</label>
                    <input type="text" name="title" class="title bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="title" required>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="category" class="category bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="cetegory" required>
                </div>
                <div class="mb-6">
