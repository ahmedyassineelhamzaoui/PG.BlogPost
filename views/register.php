      ...
      <div class="w-full bg-white rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0 ">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="#" method="post">
                  ...
                  <div>
                      <label for="password-singup" class="block mb-2 text-sm font-medium text-gray-900 ">Password</label>
                  ...
                  <div>
                      <label for="password-singup-repeat" class="block mb-2 text-sm font-medium text-gray-900 ">Confirm Password</label>
                  ...
                  <button type="submit" name="signup" class="w-full text-white bg-blue-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Sign up</button>
