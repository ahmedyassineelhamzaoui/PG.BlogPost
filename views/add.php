            ...
            <?php for ($i = 0; $i < $_SESSION["post_number"]; $i++) { ?>
                <div class="w-full px-4 border border-gray-200 bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l rounded-lg mb-2">
                    ...
                    <div class="pt-2">
                        ...
                        <textarea id="editor" name="post-content[]" rows="8" class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600" placeholder="Write an article..."></textarea>
                    </div>
